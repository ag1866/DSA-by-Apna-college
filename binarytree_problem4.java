// Q. find the diameter of tree
// Approach 1 



public class binarytree_problem4{
    static class Node{
        int data;
...
// Approach 1 to find diameter of tree
    public static int diameter(Node root){
        ...
        int diam1 = diameter(root.left);// yha se left subtree ki diameter
        int diam2 = diameter(root.right);// yha se right subtree ki diameter
        int diam3 = height(root.left) + height(root.right) + 1; // yha se root node hote hue pure tree ki diamter
        return Math.max(diam3, Math.max(diam1, diam2)); // aur phir un teeno m se jiski max uski wo apni final diamter mani jaegi 
    }
// Approach 2 to find diameter of tree
